...
export const MEDICATIONS = [
  ...
  { id: 'd11-vitc', name: 'فيتامين C', unit: 'جرام/لتر', doseValue: 1, category: 'فيتامينات', usageType: 'ضروري', recommendedHours: 8, targetDays: [11], climates: ['بارد جدا', 'بارد', 'معتدل', 'حار', 'حار جدا'], scientificExplanation: 'تخفيف حدة الإجهاد الزحامى.', mixingRules: 'إذابة تامة.', technicalSequence: 'جرعة نهارية.' },
  ...
  { id: 'd12-ad3e', name: 'فيتامينات أد3هـ (لرفع الإجهاد)', unit: 'سم³/لتر', doseValue: 1, category: 'فيتامينات', usageType: 'ضروري', recommendedHours: 12, targetDays: [12], climates: ['بارد جدا', 'بارد', 'معتدل', 'حار', 'حار جدا'], scientificExplanation: 'دعم المناعة المخاطية.', mixingRules: 'خلط جيد.', technicalSequence: 'جرعة رفع إجهاد ليلية.' },
  ...
  // Day 13
  { id: 'd13-vitc', name: 'جرعة فيتامين C', unit: 'جرام/لتر', doseValue: 1, category: 'فيتامينات', usageType: 'ضروري', recommendedHours: 8, targetDays: [13], climates: ['بارد جدا', 'بارد', 'معتدل', 'حار', 'حار جدا'], scientificExplanation: 'مضاد إجهاد حراري نهارى.', mixingRules: 'إذابة كلية.', technicalSequence: 'جرعة صباحية نهارية.' },
  ...
  // Day 15
  { id: 'd15-ese', name: 'فيتامين هـ + سيلينيوم', unit: 'سم³/لتر', doseValue: 1, category: 'فيتامينات', usageType: 'ضروري', recommendedHours: 6, targetDays: [15], climates: ['بارد جدا', 'بارد', 'معتدل', 'حار', 'حار جدا'], scientificExplanation: 'تقوية عضلات الصدر.', mixingRules: 'خلط متجانس.', technicalSequence: 'جرعة صباحية.' },
  ...
  { id: 'd15-vitc', name: 'فيتامين C', unit: 'جرام/لتر', doseValue: 1, category: 'فيتامينات', usageType: 'ضروري', recommendedHours: 6, targetDays: [15], climates: ['بارد جدا', 'بارد', 'معتدل', 'حار', 'حار جدا'], scientificExplanation: 'تخفيف حدة الإجهاد الزحامى المتزايد.', mixingRules: 'إذابة تامة.', technicalSequence: 'جرعة مسائية.' },
  ...
  // Day 19
  { id: 'd19-renal', name: 'جرعة غسيل كلوي', unit: 'سم³/لتر', doseValue: 1, category: 'كلوي/كبد', usageType: 'ضروري', recommendedHours: 6, targetDays: [19], climates: ['بارد جدا', 'بارد', 'معتدل', 'حار', 'حار جدا'], scientificExplanation: 'إزالة نواتج كورس الكوكسيديا.', mixingRules: 'خلط جيد.', technicalSequence: 'جرعة تنظيف صباحية.' },
  ...
  { id: 'd19-hepato', name: 'جرعة منشط كبد', unit: 'سم³/لتر', doseValue: 1, category: 'كلوي/كبد', usageType: 'ضروري', recommendedHours: 6, targetDays: [19], climates: ['بارد جدا', 'بارد', 'معتدل', 'حار', 'حار جدا'], scientificExplanation: 'تنشيط الكبد بعد الأدوية.', mixingRules: 'يقلب جيداً.', technicalSequence: 'جرعة مسائية.' },
  ...
  { id: 'd31-vitc', name: 'فيتامين C', unit: 'جرام/لتر', doseValue: 1, category: 'فيتامينات', usageType: 'ضروري', recommendedHours: 12, targetDays: [31], climates: ['بارد جدا', 'بارد', 'معتدل', 'حار', 'حار جدا'], scientificExplanation: 'تثبيت الحالة الصحية العامة.', mixingRules: 'إذابة تامة.', technicalSequence: 'جرعة نهارية.' },
  ...
  // Day 32
  { id: 'd32-renal', name: 'غسيل كلوي', unit: 'سم³/لتر', doseValue: 1, category: 'كلوي/كبد', usageType: 'ضروري', recommendedHours: 6, targetDays: [32], climates: ['بارد جدا', 'بارد', 'معتدل', 'حار', 'حار جدا'], scientificExplanation: 'تنظيف نهائي للكلى.', mixingRules: '1 سم/لتر.', technicalSequence: 'جرعة صباحية.' },
  ...
  { id: 'd32-hepato', name: 'منشط كبد', unit: 'سم³/لتر', doseValue: 1, category: 'كلوي/كبد', usageType: 'ضروري', recommendedHours: 6, targetDays: [32], climates: ['بارد جدا', 'بارد', 'معتدل', 'حار', 'حار جدا'], scientificExplanation: 'تنشيط الكبد لرفع جودة التصافي.', mixingRules: 'يرج جيداً.', technicalSequence: 'جرعة نهارية.' },
  ...
  { id: 'd32-bk', name: 'فيتامين B-K كولين', unit: 'سم³/لتر', doseValue: 1, category: 'فيتامينات', usageType: 'ضروري', recommendedHours: 6, targetDays: [32], climates: ['بارد جدا', 'بارد', 'معتدل', 'حار', 'حار جدا'], scientificExplanation: 'منع النزيف قبل الشحن ونهاية الدورة.', mixingRules: 'خلط متجانس.', technicalSequence: 'جرعة مسائية.' },
  ...
  { id: 'd33-bk', name: 'فيتامين B-K كولين', unit: 'سم³/لتر', doseValue: 1, category: 'فيتامينات', usageType: 'ضروري', recommendedHours: 12, targetDays: [33], climates: ['بارد جدا', 'بارد', 'معتدل', 'حار', 'حار جدا'], scientificExplanation: 'تأمين صحة الأمعاء.', mixingRules: 'إذابة تامة.', technicalSequence: 'جرعة نهارية.' },
  ...
  // Day 34
  { id: 'd34-bk', name: 'فيتامين B-K كولين', unit: 'سم³/لتر', doseValue: 1, category: 'فيتامينات', usageType: 'ضروري', recommendedHours: 12, targetDays: [34], climates: ['بارد جدا', 'بارد', 'معتدل', 'حار', 'حار جدا'], scientificExplanation: 'آخر جرعة فيتامينات لضمان جودة الجلد واللحم.', mixingRules: 'خلط متجانس.', technicalSequence: 'جرعة نهارية.' },
